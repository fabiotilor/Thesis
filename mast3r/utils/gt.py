...
def get_static_correspondences(t, view_names, scene, dataset_root,
    ...
    Strategy — work at native MASt3R pointmap resolution to avoid interpolating
    3-D points:

      1. Get MASt3R pointmap  p3d[h_mod, w_mod, 3]  and conf[h_mod, w_mod].
      ...
      5. Read the MASt3R pointmap at the same pixels  →  estimated pointmap.
