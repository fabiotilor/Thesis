...
def discover_view_name(dataset_root, K, dataset_type="dex-ycb"):
    """
    Given an intrinsic matrix K, return the folder name (e.g. 'view_01' or '4').
    """
...
def get_rgb_path(view_dir, frame_t, dataset_type="dex-ycb"):
    """
    ...
    if dataset_type == "dex-ycb":
        ...
        # Apply offset for HI4D (Imported locally to break circular dependency)
        from .gt import _get_hi4d_offset
        actual_t = frame_t + _get_hi4d_offset(action_dir)
