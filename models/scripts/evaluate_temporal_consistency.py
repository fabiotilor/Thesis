...
def main():
    ...
    os.makedirs(os.path.join("plots", args.model), exist_ok=True)
    ...
    base_in_dir = os.path.join("aligned_outputs", args.model, "baseline")
    camera_counts = [2, 3, 4]
    ...
    if subject_dirs:
        ...
        for subject_dir in subject_dirs:
            ...
            subject_plot_dir = os.path.join("plots", args.model, subject_name)
        ...
        # Write to CSV
        csv_file = f"evaluation_metrics_{args.model}.csv"
        csv_fieldnames = [
    ...
    out_plot_dir = os.path.join("plots", args.model)
    available_counts, results = evaluate_camera_configs(
