...
def compute_static_jitter(
    ...
    dict
        ...
        n_potential_anchors   : total persistent anchors before subsampling
        per_view_anchor_counts: per-view persistent anchor counts (V,)
        n_frames              : T
    ...
    # ── Per-frame validity masks: static & gt_valid & conf & finite & nonzero ──
    ...
    # ── Persistent anchor mask: (V, H, W) — must be valid in ALL frames ──
