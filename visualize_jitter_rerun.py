...
from models.scripts.utils.umeyama_alignment import apply_similarity_transform
from models.scripts.utils.gt import build_gt_validity_masks
from models.scripts.utils.camera_utils import discover_view_name
from models.scripts.eval_config import DATASETS, CONF_PERCENTILE
...
def main():
    ...
    rr.init("pi3_jitter_debug", spawn=args.spawn)
    if args.save:
        rr.save(args.save)
